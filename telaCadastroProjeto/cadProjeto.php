    ...
    <div class="container">
        ...
        <div id="banner">
            <label id="upload-banner">
                <input type="file" id="banner-projeto" accept="image/*" hidden required>
                Clique para adicionar banner
            </label>
        </div>

        <form id="formulario" action="cadProjeto.php" method="POST">
            <div id="info-projeto">
                <div id="div-capa">
                    <label id="upload-capa">
                        <input type="file" id="foto-capa" accept="image/*" hidden required>
                        📷
                    </label>
                </div>
                <div id="dados-projeto">
                    <div class="div-eixo--categoria-ano">
                        ...
                        <input type="text" id="ano-inicio" placeholder="Desde (ano)">
                    </div>
                    <input type="text" id="nome-projeto" placeholder="Nome do Projeto">
                </div>
                <input type="text" id="txt-link-inscricao" placeholder="Link p/ formulário de inscrição">
            </div>

            <div id="conteudo">
                <h2 class="subtitulo">Sobre (2000 max.)</h2>
                <textarea id="descricao" maxlength="2000" placeholder="Descreva o projeto..."></textarea>

                <input type="text" id="site-projeto" placeholder="Insira Link do site">
                ...
                <input type="text" id="link-bolsista" placeholder="Se há vagas para bolsistas, cole o link para inscrição aqui">

                <div id="contato">
                    <h2 class="subtitulo">Contato com Projeto</h2>
                    <input type="email" id="email" placeholder="E-mail para o projeto">
                    <input type="text" id="numero-telefone" placeholder="Número para contato (opcional)">
                    <input type="text" id="instagram" placeholder="Instagram do projeto (opcional)">
                </div>
